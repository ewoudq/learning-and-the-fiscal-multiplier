function output = NewKeynesianCFunc(input,shocks,states,beliefs,loc_x_obs,loc_z_obs,phi_mat,names_z_obs,parameters)
...
switch sub
    ...
    case 2 %NEW: the same as with lump-sum tax financing
        ...
        output.c=(ky*betatilde^(-1)*k_lagged+G2*w+ky*rk_ss*rk+dy*d-gy*g-G3*r+SW-SR+SPi+Srk+SD-SG)/G1;
        ...
        Invrk=beta*rk_ss*beliefs(11,:)*inv(eye(nobs)-beta*TT)*XX;
end
