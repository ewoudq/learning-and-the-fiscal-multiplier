function output = DebtCFunc(input,shocks,states,beliefs,loc_x_obs,loc_z_obs,phi_mat,names_z_obs,parameters)
...
% ** Input **
%['k ';'r ';'y ';'b ';'c ';'d ';'i ';'mc';'n ';'pi';'rk';'w ';'g ';'ur';'z '] 
k=input(1);
r=input(2);
y=input(3);
b=input(4); %different from tr adjustment
c=input(5);
d=input(6);
i=input(7);
mc=input(8);
...
q=input(11);
rk=input(12);
%tr=input(12); %different from tr adjustment
w=input(13);
...
b_lagged=endo_states(3); %different from tr adjustment
