function Output = DistortionaryTaxes(parameters,irf_shock,sigmag,sigmaz,sigmar,T,S,draw,itermax,damp,constant,gain)
...
%% Variable names
VARNAMES = ['k ';'r ';'y ';'c ';'d ';'i ';'mc';'n ';'pi';'q ';'rk';'tr';'w ';'g ';'ur';'z ']; 
names_x = {'k','r','y'}; 
...
%%
DistortionaryTaxesOptimalityConditions;
