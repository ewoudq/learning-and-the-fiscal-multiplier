function Output = NewKeynesian(parameters,irf_shock,sigmag,sigmaz,sigmar,T,S,draw,itermax,damp,constant,gain)
%NewKeynesian Summary of this function goes here
...
%% Variable names
VARNAMES = ['k ';'r ';'y ';'c ';'d ';'i ';'mc';'n ';'pi';'q ';'rk';'t ';'w ';'g ';'ur';'z ']; 
names_x = {'k','r','y'}; 
names_y = {'c','d','i','mc','n','pi','q','rk','t','w'}; 
names_z = {'g','ur','z'}; 
...
%%
NewKeynesianOptimalityConditions;
